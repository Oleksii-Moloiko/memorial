...
class SiteSettings(models.Model):
    ...
    home_media_description = models.TextField(
        ...
        default=(
            "Добірка перевірених посилань на статті, новини та офіційні документи."
        ),
    )
    ...
    videos_hero_description = models.TextField(
        "Відео — опис сторінки",
        default=("Сімейні записи, інтерв’ю, матеріали зі служби та відео вшанування."),
    )
    ...
    videos_empty_text = models.TextField(
        ...
        default=(
            "Перевірені відеоматеріали з’являться тут після публікації адміністратором."
        ),
    )
